...
VID_1 = os.environ.get("VID_1", "<b>|🇮🇳| {cleaned_name1}</b>")
VID_2 = os.environ.get("VID_2", "<b>😎 ℚ𝕦𝕒𝕝𝕚𝕥𝕪 ➠ {raw_text97}p</b>")
VID_3 = os.environ.get("VID_3", "<b>🧿 𝐁𝐀𝐓𝐂𝐇 ➤ {b_name}</b>")
VID_4 = os.environ.get("VID_4", "<b>ChapterId > {raw_text65}</b>")
